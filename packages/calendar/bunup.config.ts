...
export default defineConfig({
	...
	// @ilamy/utils, @ilamy/types, @ilamy/calendar-recurrence, @ilamy/calendar-agenda) are NOT published —
	...
	noExternal: [/^@ilamy\/(ui|utils|types|calendar-recurrence|calendar-agenda)/],
