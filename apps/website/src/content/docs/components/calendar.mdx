...
If you are upgrading from v2, audit your multi-day and all-day events: a bar
that used to reach its `end` day now stops the day before. To keep a two-day
bar, end it during the second day (`2025-01-14T23:59`) or at the following
midnight (`2025-01-15T00:00`). Timed events inside a single day are unaffected.
