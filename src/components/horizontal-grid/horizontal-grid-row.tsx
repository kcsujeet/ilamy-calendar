...
const NoMemoHorizontalGridRow: React.FC<HorizontalGridRowProps> = ({
	...
	// For flat rows, compute events once and share with GridCells + events layer.
	// For grouped rows, each GroupedColumn handles its own events.
					...
					{columns.map((col, index) => {
						...
						return col.day ? (
							<GridCell
								...
								resourceId={resource?.id}
								shouldRenderEvents={!isResourceCalendar}
 ...
 * Always resource calendar, so GridCells skip event rendering.
 */
