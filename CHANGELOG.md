...
- fix: resolve CI failures and add type checking to pipeline [`#16`](https://github.com/kcsujeet/ilamy-calendar/pull/16)
- feat: add resource calendar with month, week and day views [`#13`](https://github.com/kcsujeet/ilamy-calendar/pull/13)
- chore: simplify FUNDING.yml by removing unused funding platforms [`d68f64a`](https://github.com/kcsujeet/ilamy-calendar/commit/d68f64a81969b94d31eab3530822db724815d6ca)
- chore: update changelog  with v1..0.0 [`bf1d5a2`](https://github.com/kcsujeet/ilamy-calendar/commit/bf1d5a2c30c635154071e70cc49e17f0f54f6a06)
- chore: update changelog formatting for v1.0.0 release [`60a4b0b`](https://github.com/kcsujeet/ilamy-calendar/commit/60a4b0b8b5f7b485c6ecfc7f5964f2f0ee4c6dbd)
